    ...
    $content    =   '
                            <div class="wideContent">
                                <div id="defaultForm">
                                    <h4>about me.</h4>
                                    <p>
                                    Hello. My name is <a target="_blank" title"Josh Carlson\'s Facebook Profile" href="https://www.facebook.com/magneticstain">Josh Carlson</a> and I like <a target="_blank" title"[Wikipedia] Science" href="http://en.wikipedia.org/wiki/Science">science</a> and <a target="_blank" title"[Wikipedia] Technology" href="http://en.wikipedia.org/wiki/Technology">technology</a>.
                                    </p>
                                    <p>
                                    ...
                                    <a target="_blank" title"[Wikipedia] Hardening" href="http://en.wikipedia.org/wiki/Hardening_(computing)">Linux hardening</a>, <a target="_blank" title"[Wikipedia] Information Privacy" href="http://en.wikipedia.org/wiki/Information_privacy">privacy concerns, and <a target="_blank" title"[Wikipedia] Web-Application Security" href="http://en.wikipedia.org/wiki/Web_application_security">web-application security</a>.
                                    My language of choice when developing web-applications is <a target="_blank" title"PHP website" href="http://www.php.net/">PHP with an <a target="_blank" title"HTML5 Specs website" href="http://www.w3.org/html/wg/drafts/html/master/">HTML5 frontend</a>, but I\'m planning on
                                    delving into <a target="_blank" title"Python website" href="http://www.python.org/">python</a> website
                                    development as well since I already use python to write a majority of my larger-scale Linux scripts (<a target="_blank" title"Bash Reference Manual website" href="http://www.gnu.org/software/bash/manual/bashref.html">bash</a> is my first choice when it\'s small scale/I\'m lazy or <a target="_blank" title"Captain Morgan Black website" href="http://www.captainmorgan.com/en-row/products/black.html">drank too much</a>).
                                    </p>
                                    <p>To follow me, friend me, stalk me, annoy me, or any form of reaching my eyeballs, please visit the contact page, linked at the top.</p>
                                </div>
                            </div>';
