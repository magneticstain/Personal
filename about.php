    ...
    $content    =   '
                            <div class="wideContent">
                                <div id="defaultForm">
                                    <h4>about me.</h4>
                                    <p>
                                    Hello. My name is <a target="_blank" title="Josh Carlson\'s Facebook Profile" href="https://www.facebook.com/magneticstain">Joshua Carlson-Purcell, a/k/a Josh Carlson,</a> and I am in love with <a target="_blank" title="[Wikipedia] Science" href="http://en.wikipedia.org/wiki/Science">science</a>, <a target="_blank" title="[Wikipedia] Technology" href="http://en.wikipedia.org/wiki/Technology">technology</a>, and <a target="_blank" title="[Wikipedia] Mathematics" href="http://en.wikipedia.org/wiki/Mathematics">mathematics</a>.
                                    </p>
                                    <p>
                                    ...
                                    My language of choice when developing web-applications is <a target="_blank" title="PHP website" href="http://www.php.net/">PHP</a> with an <a target="_blank" title="HTML5 Specs website" href="http://www.w3.org/html/wg/drafts/html/master/">HTML5</a> frontend, but I\'m planning on
                                    ...
                                    <p>To follow me, friend me, stalk me, annoy me, or any form of reaching my eyeballs, please see the fancy icon links at the top of the page. :)</p>
                                    <p>
                                    - JCP
                                    </p>
                                </div>
