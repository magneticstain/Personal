    ...
    $content    =   '
                            <div class="wideContent">
                                <div id="defaultForm">
                                    ...
                                    development since it\'s my language of choice when writing the majority of my larger-scale Linux scripts (<a target="_blank" title="Bash Reference Manual website" href="http://www.gnu.org/software/bash/manual/bashref.html">bash</a> is my first choice when it\'s small scale/I\'m lazy).
                                    </p>
